...
fn multiply_batch_block(
    ...
    .executes(|| {
        ...
        // DIAGNOSTIC: memory_cleanup removed to test whether its explicit pool reindex corrupts the
        // stable resident buffers under concurrent readers. (Memory bounding restored after.)
