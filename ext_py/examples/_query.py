...
def query_module_only(prompt="Module", algebra=None):
    ...
    if algebra is not None:
        return ext_py.construct(spec, save_dir, algebra)
    return ext_py.construct(spec, save_dir)


def query_module(algebra=None):
    ...
    resolution = query_module_only("Module", algebra)
    ...
    resolution.compute_through_stem(ext_py.sseq_py.Bidegree.n_s(max_n, max_s))
    return resolution
